...
def GetIntactID_file():
    filteredIDlist = TXT_to_List(filePath="/AlphaFold_refine/UltraDataset/testData3_290entries/filteredIDlist.txt")
    with open("/AlphaFold_refine/UltraDataset/testData3_290entries/mf/train_data.txt", 'w') as file:
